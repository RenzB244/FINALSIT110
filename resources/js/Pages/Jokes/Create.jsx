...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('jokes.store'), {
            onSuccess: () => reset('title', 'content', 'category'),
        });
    };

    return (
        <AppLayout title="Write a New Joke Chapter">
            <Head title="Create Joke" />
            <div className="max-w-2xl space-y-4">
                <p className="text-xs text-slate-400">
                    This form is where you write your own chapters in the joke chronicle. Each
                    entry is tied to your account and can be edited or deleted later.
                </p>
                ...
                <form onSubmit={submit} className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="The Day JavaScript Broke My Brain"
                            required
                        />
                        {errors.title && (
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm text-slate-50 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                            placeholder="Programming, Dark, Pun..."
                        />
                        {errors.category && (
                    ...
                    <div className="space-y-1">
                        ...
                        <textarea
                            ...
                            placeholder="Write your full joke here..."
                            required
                        />
                        {errors.content && (
